import logo from '../assets/images/jewel-rock-logo-gold-mark.png';
import logoDark from '../assets/images/jewel-rock-logo-black-mark.png';
...
export const site = {
  ...
  copyright: `Copyright ${new Date().getFullYear()} JewelRock. All rights reserved.`,
};
