...
export function CateringHero() {
  return (
    <section className="catering-hero relative min-h-[min(700px,calc(100svh-var(--spacing-header)))] overflow-hidden bg-forest text-cream on-dark lg:h-[calc(100svh-var(--spacing-header))] lg:min-h-[620px]">
      <img
        ...
        fetchPriority="high"
      />
      <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(35,24,20,0.98)_0%,rgba(35,24,20,0.9)_62%,rgba(35,24,20,0.36)_100%)] sm:bg-[linear-gradient(90deg,rgba(35,24,20,0.95)_0%,rgba(35,24,20,0.86)_28%,rgba(35,24,20,0.38)_52%,rgba(35,24,20,0.08)_100%)]" />

      <div className="container-site relative z-10 flex min-h-[min(700px,calc(100svh-var(--spacing-header)))] items-center py-10 sm:py-10 lg:h-full lg:py-12">
        <div className="w-full max-w-[32rem] sm:max-w-[39rem]">
          ...
          <h1 className="mt-4 font-display text-[clamp(3rem,16vw,4.75rem)] font-semibold leading-[0.88] text-cream sm:mt-6 sm:text-[clamp(3.6rem,6.4vw,7rem)]">
            The
          ...
          <p className="mt-5 max-w-[24rem] text-[1rem] leading-7 text-cream/88 sm:mt-7 sm:max-w-[31rem] sm:text-[clamp(1.15rem,1.45vw,1.5rem)] sm:leading-snug">
          ...
          <dl className="mt-7 hidden max-w-[37rem] grid-cols-1 gap-4 text-cream min-[460px]:grid-cols-3 min-[460px]:items-start min-[460px]:gap-0 min-[460px]:text-center sm:mt-9 lg:grid">
